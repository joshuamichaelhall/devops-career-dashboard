#!/bin/bash
# Debug Personal Dashboard Script
# This script starts the dashboard with debugging and minimal file watching

# Display banner
echo "====================================================="
echo "      DevOps Career Dashboard - Debug Mode           "
echo "====================================================="
echo ""
...
# Create .env.development with minimal watching
...
# Start the React app with disabled hot reloading
echo "🚀 Starting React frontend on port 3000 (debug mode)..."
echo "   - Frontend will be available at: http://localhost:3000"
echo "   - API server will be available at: http://localhost:3005"
echo ""

# Run React app with minimal watching
FAST_REFRESH=false \
WATCHPACK_POLLING=true \
CHOKIDAR_USEPOLLING=true \
CHOKIDAR_INTERVAL=5000 \
